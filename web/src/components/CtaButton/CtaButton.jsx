    ...
    <div className="relative flex items-center justify-center">
      <div className="relative flex flex-col items-center">
        <img
          ...
          className="absolute right-0 top-0 mr-[-40px] mt-[-15px] h-auto w-auto object-cover"
        />
        <button
        ...
        <img
          ...
          className="absolute bottom-0 left-0 mb-[-15px] ml-[-40px] h-auto w-auto rotate-180 object-cover"
        />
      </div>
    </div>
  )
